...
# 3. Assembly (de novo)
skesa --fastq input_data/${SRR}_1.fastq,input_data/${SRR}_2.fastq --cores 8 --memory 10 > output_data/assembly.fasta
...
# 5. Annotation
prokka --outdir work/prokka --prefix genome --cpus 8 --force output_data/assembly.fasta
